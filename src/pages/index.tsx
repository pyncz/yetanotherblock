...
import { HeadMeta, Section, TokensSection, TrendingCollectionsSection } from '../components'
...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      <div className="lg:tw-sticky tw-top-0 tw-min-h-full sm:tw-col-[1/3] lg:tw-col-[2] sm:tw-row-[3] lg:tw-row-[1/5]">
        <TokensSection />
      </div>
    </>
  )
